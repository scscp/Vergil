...
export sem=$( curl -s https://raw.githubusercontent.com/scscp/Vergil/main/permission/versions)
...
echo -e "                 ${BICyan}Base Script :${BIPurple}Candra Vpn Store${NC}"
echo -e "                 ${BICyan}Order SC WA :${BIPurple}081573872702${NC}"
echo -e "                 ${BICyan}TELEGRAM    :${BIPurple} @boootzzzz${NC}"
echo -e "                 ${BICyan}${On_IPurple}SCRIPT MULTI By ${UWhite}KINGSTORE${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e " ${BICyan}│  ${BICyan}Use Core        :  ${BIPurple}XRAY${NC}"
echo -e " ${BICyan}│  ${BICyan}OS              :  "$(hostnamectl | grep "Operating System" | cut -d ' ' -f5-) ${NC}
echo -e " ${BICyan}│  ${BICyan}KERNEL          :  $(uname -r) ${NC} "
echo -e " ${BICyan}│  ${BICyan}UPTIME          :  $uptime ${NC} "
